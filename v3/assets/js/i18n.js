...
['Yacht & Boat Charter','Crewed · Provisioned · Private',
 'A crewed yacht, prepared entirely around your wishes. Or a fast boat for the afternoon. Routes built to order, the finest stretches of coast, and complete freedom of movement on the water.',
...
['Helicopter Charter','Rotor · Helipad · Twenty minutes',
 ...
 'Scenic flights over Rio and Foz do Iguaçu','Landing permissions and ground handling','Request a helicopter'],
...
['Accounting & Company Formation','CNPJ · Books · Filings',
 'A company registered properly the first time, and an accountant who files on time every month. Nothing here is left for you to remember.',
...
['Market Entry','Bringing your business in',
 'You already have a business. We bring it into South America: the legal structure, the local entity, the partners, the distribution, and the people who will run it day to day.',
...
['Business Launch Support','From nothing to open',
 'Starting something new in South America from a blank page. Concept, registration, premises, staff, suppliers and the first ninety days — with one person accountable throughout.',
...
['Buying and renting homes','Acquiring a place to live',
 'Buying a home in South America as a foreigner is legal and straightforward — provided the title is clean, the seller is who they claim to be, and somebody reads every line.',
...
['Investment Accounts','Moving money in, legally',
 'An investment account opened so money reaches South America legally and without a three-week silence. Capital registered with the central bank, so it can leave again when you want it to.',
 'Investment and brokerage accounts','International transfers into South America',
...
['Travel Guide','The whole continent, with someone who knows it',
 'A guide who knows which door to use, which restaurant is worth the drive, and which beach empties after four. Brazil, Argentina, Paraguay — across the whole continent, not one city.',
 'Private guiding in any South American country','Historic centres, nature and coastline',
...
['Full Travel Services','Booked and arranged',
 ...
 'Flights, hotels and pousadas','Route planning across countries',
...
['Executive Protection','Licensed · Personal escort · Safety',
 'Professional close protection, routes checked in advance, secure residences and an escort at every stage of the journey. A discreet presence that brings peace of mind and safety.',
...
['Iates e lanchas','Com tripulação · Abastecido · Privado',
 'Um iate tripulado, preparado inteiramente conforme os seus desejos. Ou uma lancha rápida para a tarde. Roteiros sob medida, os melhores litorais e total liberdade de movimento na água.',
...
['Fretamento de helicóptero','Rotor · Helponto · Vinte minutos',
 ...
 'Voos panorâmicos sobre o Rio e Foz do Iguaçu','Autorizações de pouso e apoio em solo','Solicitar um helicóptero'],
...
['Contabilidade e abertura de empresas','CNPJ · Escrita · Obrigações',
 'Uma empresa registrada corretamente da primeira vez, e um contador que entrega tudo no prazo todo mês. Nada aqui fica na sua memória.',
...
['Entrada no mercado','Trazendo o seu negócio',
 'Você já tem um negócio. Nós o trazemos para a América do Sul: estrutura jurídica, entidade local, parceiros, distribuição e as pessoas que vão tocar isso todo dia.',
...
['Abertura de negócio','Do zero até abrir as portas',
 'Começar algo novo na América do Sul a partir de uma folha em branco. Conceito, registro, ponto, equipe, fornecedores e os primeiros noventa dias — com um responsável do começo ao fim.',
...
['Compra e aluguel de imóveis','Adquirir para morar',
 'Comprar uma casa na América do Sul sendo estrangeiro é legal e simples — desde que a matrícula esteja limpa, o vendedor seja quem diz ser e alguém leia cada linha.',
...
['Contas de investimento','Trazendo dinheiro de forma legal',
 'Uma conta de investimento aberta para que o dinheiro chegue à América do Sul legalmente e sem três semanas de silêncio. Capital registrado no Banco Central — ou seja, pode sair de novo.',
 'Contas de investimento e corretora','Transferências internacionais para a América do Sul',
...
['Guia de viagem','O continente inteiro com quem conhece',
 'Um guia que sabe por qual porta entrar, qual restaurante vale a viagem e qual praia esvazia depois das quatro. Brasil, Argentina, Paraguai — pelo continente inteiro, não por uma cidade só.',
 'Guia privado em qualquer país da América do Sul','Centros históricos, natureza e litoral',
...
['Serviços de viagem','Reservado e organizado',
 ...
 'Voos, hotéis e pousadas','Planejamento de roteiro entre países',
...
['Proteção executiva','Licenciada · Acompanhamento pessoal · Segurança',
 'Proteção pessoal profissional, rotas verificadas com antecedência, residências seguras e acompanhamento em cada etapa da viagem. Uma presença discreta que garante tranquilidade e segurança.',
...
['Yates y lanchas','Con tripulación · Aprovisionado · Privado',
 'Un yate con tripulación, preparado por completo según sus deseos. O una lancha rápida para la tarde. Rutas a medida, las mejores costas y total libertad de movimiento en el agua.',
...
['Alquiler de helicóptero','Rotor · Helipuerto · Veinte minutos',
 ...
 'Vuelos panorámicos sobre Río y Foz de Iguazú','Permisos de aterrizaje y asistencia en tierra','Solicitar un helicóptero'],
...
['Contabilidad y constitución de empresas','CNPJ · Libros · Declaraciones',
 'Una empresa registrada bien a la primera, y un contador que presenta a tiempo todos los meses. Aquí no queda nada a su memoria.',
...
['Entrada al mercado','Traemos su negocio',
 'Usted ya tiene un negocio. Nosotros lo traemos a América del Sur: la estructura jurídica, la entidad local, los socios, la distribución y las personas que lo llevarán día a día.',
...
['Lanzamiento de negocio','De cero a abrir',
 'Empezar algo nuevo en América del Sur desde una hoja en blanco. Concepto, registro, local, equipo, proveedores y los primeros noventa días — con un responsable de principio a fin.',
...
['Compra y alquiler de vivienda','Adquirir para vivir',
 'Comprar una casa en América del Sur siendo extranjero es legal y sencillo — siempre que el título esté limpio, el vendedor sea quien dice ser y alguien lea cada línea.',
...
['Cuentas de inversión','Traer el dinero de forma legal',
 'Una cuenta de inversión abierta para que el dinero llegue a América del Sur legalmente y sin tres semanas de silencio. Capital registrado en el banco central — es decir, también puede salir.',
 'Cuentas de inversión y de bróker','Transferencias internacionales a América del Sur',
...
['Guía de viaje','Todo el continente con quien lo conoce',
 'Un guía que sabe por qué puerta entrar, qué restaurante merece el viaje y qué playa se vacía después de las cuatro. Brasil, Argentina, Paraguay — por todo el continente, no por una sola ciudad.',
 'Guía privado en cualquier país de América del Sur','Centros históricos, naturaleza y costa',
...
['Servicios de viaje','Reservado y organizado',
 ...
 'Vuelos, hoteles y pousadas','Planificación de ruta entre países',
...
['Protección ejecutiva','Licenciada · Acompañamiento personal · Seguridad',
 'Protección personal profesional, rutas verificadas con antelación, residencias seguras y acompañamiento en cada etapa del viaje. Una presencia discreta que garantiza tranquilidad y seguridad.',
...
['Yacht e barche','Con equipaggio · Rifornito · Privato',
 'Uno yacht con equipaggio, preparato interamente secondo i suoi desideri. O un motoscafo veloce per il pomeriggio. Itinerari su misura, le coste migliori e totale libertà di movimento in acqua.',
...
['Noleggio elicottero','Rotore · Elisuperficie · Venti minuti',
 ...
 'Voli panoramici su Rio e Foz do Iguaçu','Permessi di atterraggio e assistenza a terra','Richiedere un elicottero'],
...
['Contabilità e apertura società','CNPJ · Libri · Adempimenti',
 'Una società registrata bene la prima volta, e un commercialista che deposita in tempo ogni mese. Qui non resta nulla alla sua memoria.',
...
['Ingresso nel mercato','Portiamo dentro la sua azienda',
 'Lei ha già un’azienda. Noi la portiamo in Sud America: struttura giuridica, entità locale, partner, distribuzione e le persone che la manderanno avanti ogni giorno.',
...
['Avvio dell’attività','Dal foglio bianco all’apertura',
 'Cominciare qualcosa di nuovo in Sud America da zero. Concept, registrazione, locale, personale, fornitori e i primi novanta giorni — con un solo responsabile lungo tutto il percorso.',
...
['Acquisto e affitto immobili','Acquisire per viverci',
 'Comprare casa in Sud America da straniero è legale e lineare — a condizione che il titolo sia pulito, che il venditore sia chi dice di essere e che qualcuno legga ogni riga.',
...
['Conti d’investimento','Far entrare il denaro legalmente',
 'Un conto d’investimento aperto perché il denaro arrivi in Sud America legalmente e senza tre settimane di silenzio. Capitale registrato presso la banca centrale — quindi può anche uscire.',
 'Conti d’investimento e di intermediazione','Bonifici internazionali verso il Sud America',
...
['Guida turistica','Tutto il continente con chi lo conosce',
 'Una guida che sa da quale porta entrare, quale ristorante vale il viaggio e quale spiaggia si svuota dopo le quattro. Brasile, Argentina, Paraguay — in tutto il continente, non in una sola città.',
 'Guida privata in qualsiasi paese del Sud America','Centri storici, natura e costa',
...
['Servizi di viaggio','Prenotato e organizzato',
 ...
 'Voli, hotel e pousadas','Pianificazione dell’itinerario tra paesi',
...
['Protezione personale','Autorizzata · Accompagnamento personale · Sicurezza',
 'Protezione personale professionale, percorsi verificati in anticipo, residenze sicure e accompagnamento in ogni fase del viaggio. Una presenza discreta che garantisce tranquillità e sicurezza.',
