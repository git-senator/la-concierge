...
(function (global) {
  ...
  DICT.en = {
    ...
    'conc.signName': 'No. 1 concierge from North to South America',
    ...
    'form.consent': 'By submitting you agree to be contacted about this request. Your details are never shared or used for marketing.',
...
['It is done','You arrive. Everything is already where it should be, and nobody has to be told twice.']
  ...
  DICT.pt = {
    ...
    'conc.signName': 'Concierge nº 1 da América do Norte à América do Sul',
    ...
    'form.consent': 'Ao enviar, você concorda em ser contatado sobre esta solicitação. Seus dados nunca são compartilhados nem usados para marketing.',
...
['Está feito','Você chega. Tudo já está onde deveria estar, e ninguém precisa ouvir duas vezes.']
  ...
  DICT.es = {
    ...
    'conc.signName': 'Conserjería n.º 1 de América del Norte a América del Sur',
    ...
    'form.phPhone': '+55 11 90000 0000',
    'form.phEmail': 'nombre@empresa.com',
    ...
    'form.sending': 'Enviando…',
    'form.consent': 'Al enviar, acepta que le contactemos por esta solicitud. Sus datos nunca se comparten ni se usan para marketing.',
...
['Está hecho','Usted llega. Todo está ya donde debe estar, y a nadie hay que decírselo dos veces.']
  ...
  DICT.it = {
    ...
    'conc.signName': 'Concierge n. 1 dall’America del Nord all’America del Sud',
    ...
    'form.sending': 'Invio…',
    'form.consent': 'Inviando, acconsente a essere contattato in merito a questa richiesta. I suoi dati non vengono mai condivisi né usati per marketing.',
