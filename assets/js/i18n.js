...
['Transfers Across South America','From São Paulo, anywhere',
 'Out of São Paulo to anywhere on the continent — Rio, Angra, Búzios, Campos do Jordão, the interior. One car, one driver, one price agreed before departure.',
...
['Travel Guide','South America, with someone who knows it',
 'A guide who knows which door to use, which restaurant is worth the drive, and which beach empties after four. Across the whole continent, not one city.',
...
['Transfers por toda a América do Sul','De São Paulo, para onde for',
 'De São Paulo para qualquer ponto do continente — Rio, Angra, Búzios, Campos do Jordão, o interior. Um carro, um motorista, um preço combinado antes da saída.',
...
['Guia de viagem','A América do Sul com quem conhece',
 'Um guia que sabe por qual porta entrar, qual restaurante vale a viagem e qual praia esvazia depois das quatro. Pelo continente inteiro, não por uma cidade só.',
...
['Traslados por toda América del Sur','Desde São Paulo, adonde sea',
 'Desde São Paulo a cualquier punto del continente — Río, Angra, Búzios, Campos do Jordão, el interior. Un coche, un chofer, un precio acordado antes de salir.',
...
['Guía de viaje','América del Sur con quien la conoce',
 'Un guía que sabe por qué puerta entrar, qué restaurante merece el viaje y qué playa se vacía después de las cuatro. Por todo el continente, no por una sola ciudad.',
...
['Transfer in tutto il Sud America','Da San Paolo, ovunque',
 'Da San Paolo verso qualsiasi punto del continente — Rio, Angra, Búzios, Campos do Jordão, l’interno. Un’auto, un autista, un prezzo concordato prima di partire.',
...
['Guida turistica','Il Sud America con chi lo conosce',
 'Una guida che sa da quale porta entrare, quale ristorante vale il viaggio e quale spiaggia si svuota dopo le quattro. In tutto il continente, non in una sola città.',
