...
(function (global) {
  ...
  DICT.en = {
    ...
    'lp.one.txt': 'One number for matters that usually take dozens of contacts.<br>You put the wish into words.<br>We turn it into reality.',
...
['It is done','You arrive. Everything is already where it should be, and nobody has to be told twice.']
  ...
  DICT.pt = {
    ...
    'lp.one.txt': 'Um número para assuntos que normalmente exigem dezenas de contatos.<br>Você formula o desejo.<br>Nós o transformamos em realidade.',
...
['Está feito','Você chega. Tudo já está onde deveria estar, e ninguém precisa ouvir duas vezes.']
  ...
  DICT.es = {
    ...
    'lp.one.txt': 'Un número para asuntos que normalmente exigen decenas de contactos.<br>Usted formula el deseo.<br>Nosotros lo hacemos realidad.',
...
['Está hecho','Usted llega. Todo está ya donde debe estar, y a nadie hay que decírselo dos veces.']
  ...
  DICT.it = {
    ...
    'lp.one.h3': 'Un concierge.',
    'lp.one.txt': 'Un numero per questioni che di solito richiedono decine di contatti.<br>Lei formula il desiderio.<br>Noi lo rendiamo realtà.',
